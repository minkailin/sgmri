...
the slight decrease in the most unstable $k_x$.) %Since axisymmetric GI
...
rates at large $k_x$, but the effect is small. %can be used for code
                                %test 
Note that this 
destabilization is through the linear response, rather than through
the background stratification (which is stabilizing). 
%For the $k_x$ in the GI
%interval, MRI is weakly stabilized by self-gravity. 
...
%implications for simulations -> need to resolve small-scales 

%Fig. \ref{compare_growth3_Q01d2} again shows smooth
%transitions between MRI and GI. This means the MRI and GI do indeed
%interact, but 

%In particular, modes with $1.5 \lessim
%k_xH\lesssim2$ is neither pure



%demonstrates that mode classification
%becomes ambigious when both GI and MRI are present. 
