...
\subsubsection{Uniform
  resistivity}   
%We calculate the MRI as a function of $Q$ with uniform
...
%As expected growth rates generally decrease with decreasing 
%$\Lambda_0$ \citep{jin96}. 
...
MRI by making $ 2H<\lambda $.  %these perts are not gravitationally
                               %unstable  
...
%{\bf DISCUSS STRESS} Although for ideal MHD self-gravity makes no
%difference to the MRI growth rate, we find the associated stress does
%change with $Q$. 
...
% field, i
 Self-gravity plays does not affect the MRI in this regime.   
