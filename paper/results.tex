...
For ideal MHD and a weak field ($\Lambda_0>1$, $\beta=100$), there is
negligible dependence on $Q$. However, with $\beta=25$ or 
...
In the ideal limit with $\beta=100$, we find $\lambda < 2H$
...
Self-gravity also appreciably decreases the MRI growth rates in the
...
the dependence of $\lambda/H$ on $f(Q)$ is amplified by the
...
%We find qualitatively similar results for large $A$ with small
%  $\Lambda_0$. 
