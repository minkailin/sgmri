...
{\bf 
For a vertical field, considered in \S\ref{result1} and
...
%and 
%the potential boundary condition is 
\begin{align}
...
%In practice,  Eq. \ref{pot_bc1} and \ref{pot_bc2} are
%very similar because $\rho(\pm\zmax)\ll\rho_0$. 
%}

\subsubsection{Case 1: vertical field}
{\bf Here we impose} $d\bm{U}/dz=0$ at $z=0$. This permits higher
...
\end{align}
so the field remains vertical. {\bf The derivation of the magnetic
...
$z\in[-Z_s, Z_s]$ {\bf and no symmetry across the midplane is
...
\end{align}
    {\bf and this case permits $\dd v_z(\pm Z_s)\neq0$.}
%      In practice, the gravitational potential boundary condition is
%      similar to case 1 because $\rho(\pm Z_s)\ll\rho_0$.}
