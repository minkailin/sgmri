...
\subsubsection{Case 1: vertical field}%because SG can only destabilize
                                %symmetric density perts%for
                                %simplicity
%for future simulations (set vertical field)
...
$z$. 
%The colorbar quantifies the importance of
%self-gravity with 
