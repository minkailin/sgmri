...
\begin{abstract}
  ...
  with radial lengthscales on the order of the disk thickness, self-gravity 
...
negligible computational cost. This  allows us to indentify
...
\S\ref{result2}, and equilibra including an azimuthal field is explored in
