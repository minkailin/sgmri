...
C            to be unique in combined single/double precision code
C            (ACH).
C  19920722  Minor revisions to prologue (ACH).
C  19920831  Conversion to double precision done (ACH).
C  19921106  Fixed minor bug: ETAQ,ETAQM1 in DVSTEP SAVE statement
C  (ACH).
C  19921118  Changed LUNSAV/MFLGSV to IXSAV (ACH).
C  19941222  Removed MF overwrite; attached sign to H in estimated
C  second 
